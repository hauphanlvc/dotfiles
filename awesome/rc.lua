...
globalkeys = gears.table.join(
	...
	end, { description = "incShift master width factor", group = "layout" }),
	...
	awful.key({ modkey, "Shift" }, "s", function()
		...
		awful.util.spawn_with_shell(
			"sleep 0.2 && scrot -s /tmp/screenshot.png && xclip -selection clipboard -t image/png -i /tmp/screenshot.png && rm /tmp/screenshot.png"
		)
		-- awful.util.spawn(
		-- 	"sleep 0.5 && scrot -s -o /tmp/screenshot.png && xclip -selection clipboard -t image/png -i /tmp/screenshot.png"
		-- )
...
awful.spawn('xinput set-prop "MSFT0001:00 04F3:3140 Touchpad" "libinput Tapping Enabled" 1')
